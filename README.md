...
```javascript
import array from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-array@v0.2.3-deno/mod.js';
```
...
[@stdlib/array/generic]: https://github.com/stdlib-js/array-generic/tree/deno
